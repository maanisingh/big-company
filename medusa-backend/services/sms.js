...
var SMSService = /** @class */ (function () {
     ...
     */
    SMSService.prototype.formatPhone = function (phone) {
     ...
     */
    SMSService.prototype.send = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var recipients, formattedRecipients, result, error_1;
            var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        if (!this.sms) {
                            ...
                            return [2 /*return*/, { success: true, messageId: 'dev-' + Date.now() }];
                        }
                        _d.label = 1;
                    case 1:
                        _d.trys.push([1, 3, , 4]);
     ...
     */
    SMSService.prototype.sendSms = function (phone, message) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.send({ to: phone, message: message })];
            });
        });
    };
    /**
     ...
     */
    SMSService.prototype.sendOTP = function (phone, otp) {
        return __awaiter(this, void 0, void 0, function () {
            var message;
            return __generator(this, function (_a) {
     ...
     */
    SMSService.prototype.sendOrderConfirmation = function (phone, orderNumber, total) {
        return __awaiter(this, void 0, void 0, function () {
            var message;
            return __generator(this, function (_a) {
     ...
     */
    SMSService.prototype.sendPaymentConfirmation = function (phone, amount, reference) {
        return __awaiter(this, void 0, void 0, function () {
            var message;
            return __generator(this, function (_a) {
     ...
     */
    SMSService.prototype.sendLoanApproval = function (phone, amount, dueDate) {
        return __awaiter(this, void 0, void 0, function () {
            var message;
            return __generator(this, function (_a) {
     ...
     * Send loan reminder
     */
    SMSService.prototype.sendLoanReminder = function (phone, loanNumber, amount, dueDate) {
        return __awaiter(this, void 0, void 0, function () {
            var message;
            return __generator(this, function (_a) {
     ...
     */
    SMSService.prototype.sendGasTopupConfirmation = function (phone, meterNumber, amount, units, token) {
        return __awaiter(this, void 0, void 0, function () {
            var message;
            return __generator(this, function (_a) {
     ...
     */
    SMSService.prototype.sendWalletTopup = function (phone, amount, newBalance) {
        return __awaiter(this, void 0, void 0, function () {
            var message;
            return __generator(this, function (_a) {
     ...
     */
    SMSService.prototype.sendLowStockAlert = function (phone, productName, currentStock) {
        return __awaiter(this, void 0, void 0, function () {
            var message;
            return __generator(this, function (_a) {
     ...
     */
    SMSService.prototype.sendCreditOrderApproval = function (phone, orderNumber, amount, dueDate) {
        return __awaiter(this, void 0, void 0, function () {
            var message;
            return __generator(this, function (_a) {
