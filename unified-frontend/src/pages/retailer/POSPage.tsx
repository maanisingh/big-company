...
const POSPage = () => {
  ...
  const handlePayment = async () => {
    ...
    switch (paymentMethod) {
      ...
      case 'nfc':
        // For now, treat NFC as cash (would need hardware integration)
        await completeSale('nfc');
        break;
        ...
        <Card size="small" style={{ marginBottom: '16px' }}>
          <Row gutter={16}>
            ...
            <Col span={4}>
              <Statistic
                title="NFC"
                value={dailyStats.nfc_transactions || 0}
            ...
            <Col span={4}>
              <Statistic
                title="Cash"
                value={dailyStats.cash_transactions || 0}
            ...
            <Col span={6}>
              <Statistic
                title="Wallet/Credit"
                value={(dailyStats.wallet_transactions || 0) + (dailyStats.credit_transactions || 0)}
