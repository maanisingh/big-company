        ...
        >
          ...
          >
            <Row gutter={24} align="middle">
              <Col xs={24} md={12}>
                <div>
                  <Text style={{ color: 'rgba(255,255,255,0.8)', fontSize: '14px' }}>Available Balance</Text>
              ...
              <Col xs={24} md={12} style={{ textAlign: 'right' }}>
                <Space>
                  <Button icon={<PlusOutlined />} ghost style={{ borderColor: 'white', color: 'white' }}>
                    Add Funds
                  </Button>
                  <Button icon={<SendOutlined />} type="primary" style={{ background: 'rgba(255,255,255,0.2)', borderColor: 'white' }}>
                    Transfer
                  </Button>
                </Space>
              </Col>
          ...
          {/* Transaction History */}
          <Card title={<><HistoryOutlined /> Transaction History</>}>
