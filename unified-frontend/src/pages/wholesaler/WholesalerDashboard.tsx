...
export const WholesalerDashboard: React.FC = () => {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      setStats({
        ...response.data,
        growth: { retailers: 8.5, orders: 12.3, revenue: 15.7 },
      });
        ...
        <Alert
          message={
            <Space split={<Divider type="vertical" />}>
              <span><FireOutlined style={{ color: '#fa541c' }} /> Today's Sales: <Text strong>8,500,000 RWF</Text></span>
              <span><TruckOutlined style={{ color: '#1890ff' }} /> Orders Shipped: <Text strong>34</Text></span>
              <span><TeamOutlined style={{ color: '#52c41a' }} /> New Retailers: <Text strong>3</Text></span>
            </Space>
          }
          type="info"
          showIcon={false}
        ...
        {[
          {
            ...
            icon: <TeamOutlined />,
            color: '#722ed1',
            suffix: <Text type="secondary" style={{ fontSize: 14 }}>{stats?.activeRetailers || 0} active</Text>,
            growth: stats?.growth?.retailers,
          },
          {
            title: 'Total Orders',
